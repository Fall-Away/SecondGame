...
public class boss : MonoBehaviour
{
   ...
   public Transform bullettr2;
   public Transform bullettr3;
   public Transform bullettr4;
   [SerializeField]
   ...
   StartCoroutine("shot");
    ...
    shoting=true;
        ...
        Instantiate(enemyBullet, bullettr.transform.position,transform.rotation);
                Instantiate(enemyBullet, bullettr2.transform.position,transform.rotation);
                        Instantiate(enemyBullet2, bullettr3.transform.position,transform.rotation);
                                Instantiate(enemyBullet2, bullettr4.transform.position,transform.rotation);
